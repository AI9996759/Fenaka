    ...
    <td>
        ...
        <td bgcolor="#44525f" class="header">
          ...
          <tr>
            <td height="70">
              ...
              <tr>
                <td class="h1" style="padding: 5px 0 0 0; color: #e4e4e4;" >
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
          <span style="font-size: 50px; font-family: Impact, Charcoal, sans-serif; color: #dc3545;">
          REJECTED
          </span>
          </tr>
          <tr>
          ...
          <tr>
            <td class="bodycopy">
              <b>Reason For Rejection:</b> {{$rejected_reson}}
            </td>
          </tr>
          </table>
        </td>
        ...
        <td class="innerpadding borderbottom">
          ...
          <tr>
            <td>
              ...
              <tr>
                <td class="bodycopy">
                <b> Vendor Reference Number:</b> {{$number}}
                </td>
              </tr>
              <tr>
                <td class="bodycopy">
              ...
              <tr>
                <td class="bodycopy">
                <b> Rejected Date:</b> {{$rejected_date}}
                </td>
              </tr>
              <tr>
              <tr>
